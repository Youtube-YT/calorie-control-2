...
else if(male.checked && youndAdult.checked ){
...
else if(female.checked && youndAdult.checked ){
...
var sendetary = document.querySelector(".sendetary");
var light = document.querySelector(".light");
var moderate = document.querySelector(".moderate");
var active = document.querySelector(".active");
var dailyIntake;
var resaultMessage = document.querySelector("#resaultMessage");
